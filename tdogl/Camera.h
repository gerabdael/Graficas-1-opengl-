...
namespace tdogl {
	...
	public:
		...
		void setCameraType(const bool& thidPerson);
		...
		/**
		 The combined camera transformation matrix, including orthographic projection.

		 This is the complete matrix to use in the gui shader.
		 */
		...
		/**
		 The orthographic transformation matrix
		 */
		glm::mat4 orthographic() const;
		/**
